...
public class BuyBaseTicketHelperTest {
	...
	public void testGetRemainingTicketsWhenFilmDoesNotExist() {
		...
		assertThat(buyBaseTicketHelper.getRemainingTickets(FILM_ID)).isZero();
	...
	public void testGetRemainingTicketsWhenOneIsLeft() {
		...
		assertThat(buyBaseTicketHelper.getRemainingTickets(FILM_ID)).isEqualTo(expectedRemainingTickets);
